...
export function RoomSidebar({ rooms, currentRoom, onRoomSelect, onCreateRoom, onlineUsers }: RoomSidebarProps) {
  ...
  const handleCreateRoom = async () => {
    ...
    setIsCreating(true)
    try {
      await onCreateRoom(newRoomName.trim(), newRoomDescription.trim() || undefined)
      setNewRoomName("")
    ...
    <div className="w-64 bg-card border-r border-border flex flex-col">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {room.description && <p className="text-xs opacity-70 truncate">{room.description}</p>}
                </div>
                {room.memberCount && (
      ...
      <div className="border-t border-border p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <span className="text-sm font-medium text-foreground">Online ({onlineUsers.length})</span>
        </div>
