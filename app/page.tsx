...
import { MessageSquare, Shield, Zap, Users, Database, Activity, ArrowRight, CheckCircle } from "lucide-react"
...
export default function HomePage() {
  ...
  const features = [
    {
      ...
      description: "Secure authentication and API management with enterprise-grade Kong Gateway",
      color: "text-blue-500",
    },
    {
      icon: MessageSquare,
      title: "Real-time Messaging",
      description: "Instant messaging with WebSocket support and message persistence",
  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="text-center space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-balance">
                Enterprise-grade messaging application with real-time communication, secure authentication, and
                comprehensive API management through Kong Gateway.
              </p>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-24">
        <div className="text-center space-y-4 mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Built with modern technologies and enterprise-grade infrastructure for reliable, scalable real-time
            communication.
          </p>
        </div>
      ...
      <div className="bg-muted/30">
        <div className="max-w-7xl mx-auto px-4 py-24">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Comprehensive REST API with WebSocket support for real-time features. All endpoints are secured and
              rate-limited through Kong Gateway.
            </p>
          </div>
              ...
              <div className="space-y-3">
                {apiEndpoints.map((endpoint, index) => (
                  <div key={index} className="flex items-center gap-4 p-3 rounded-lg bg-muted/50">
                    ...
                    <code className="font-mono text-sm text-primary flex-1">{endpoint.path}</code>
      ...
      <div className="max-w-7xl mx-auto px-4 py-24">
        <div className="text-center space-y-4 mb-16">
          <h2 className="text-3xl font-bold text-foreground">Architecture Overview</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Microservices architecture with Kong API Gateway managing authentication and chat services for optimal
          ...
          <CardContent className="p-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">Next.js application with real-time messaging interface</p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    <CheckCircle className="h-4 w-4 text-green-500" />
                    <span className="text-muted-foreground">React Components</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <CheckCircle className="h-4 w-4 text-green-500" />
              ...
              <div className="text-center space-y-4">
                ...
                <h3 className="font-semibold text-foreground">Backend Services</h3>
                <p className="text-sm text-muted-foreground">Auth and Chat microservices with database persistence</p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm">
                    <CheckCircle className="h-4 w-4 text-green-500" />
                    <span className="text-muted-foreground">Auth Service (3001)</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <CheckCircle className="h-4 w-4 text-green-500" />
                    <span className="text-muted-foreground">Chat Service (3002)</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm">
                    <CheckCircle className="h-4 w-4 text-green-500" />
      ...
      <div className="bg-primary/5 border-t border-border">
        <div className="max-w-7xl mx-auto px-4 py-24 text-center">
          <div className="space-y-6">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Join the Kong Chat platform and experience enterprise-grade messaging with real-time communication and
              robust security.
            </p>
            <Button
              size="lg"
